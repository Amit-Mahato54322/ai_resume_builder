...
* **Languages & Frameworks:** JavaScript, React, Python, Node.js/Express, Flask, HTML5/CSS3, SQL, C# / .NET (Self-Directed/Basic), Angular (Prior Exposure)
* **Databases & Tools:** PostgreSQL, Git, Docker, Apache Airflow, RESTful APIs, Microservices Architecture
* **AI & Next-Gen Tooling:** AI-assisted development (GitHub Copilot, ChatGPT prompt-engineering for code migration), automated unit test generation
...
* **Emphasized "Legacy Modernization":** 
...
* **Reframed Core Contributions to Match "Impact" and "On-Call":**
  * *Why:* The JD calls for a "customer-first mentality," owning quality "end-to-end," and participating in a "lightweight on-call rotation." I restructured existing testing bullets to emphasize "owning quality end-to-end" and explicitly mentioned production support/on-call rotation experience.
* **Softened the "Years of Experience" Gap in the Summary:**
  * *Why:* Rather than starting the summary with "3 years of experience," which might lead to immediate rejection based on the "6+ years" requirement, the summary now leads with strong capability statements ("proven track record of modernizing legacy systems," "AI-assisted engineering") to prove value before the reviewer looks at the chronology.
